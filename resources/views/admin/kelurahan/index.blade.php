...
@section('title', auth()->user()->name.' | Kelurahan')
@section('content')
   ...
   <div class="col-sm-12">
        ...
        style="background: #3a7bd5;  /* fallback for old browsers */
                ...
                id="float" class="btn btn-primary text-light"><i class="fas fa-plus"> Tambah Data</i></a><br><br>
                            <table id="kelurahan_table" class="table table-striped table-bordered nowrap role="grid" aria-describedby="simpletable_info"">
   <thead>
                <tr>
                    <th>NO</th>
                    <th>NAMA PROVINSI</th>
