        ...
        <div class="footer-widgets-wrap clearfix">
            ...
            <div class="col_two_fifth">
                ...
                <div class="widget clearfix">
                    ...
                    <img src="{{asset('asset/demos/real-estate/images/logo@2x.png')}}"
                    ...
                    <div class="widget subscribe-widget subscribe-form clearfix" data-loader="button">
                        ...
                        <form action="include/subscribe.php" method="post" class="nobottommargin">
                            <input type="email" id="widget-subscribe-form-email" name="widget-subscribe-form-email"
                                class="sm-form-control not-dark required email" placeholder="Enter your Email">
                            <button class="button button-3d button-black noleftmargin norightmargin"
                                style="margin-top: 15px;" type="submit">Subscribe</button>
                        </form>
                    </div>
