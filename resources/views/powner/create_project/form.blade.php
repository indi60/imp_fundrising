							...
							<div class="col-lg-12">
                                <form action="{{ empty($data) ? ('/powner/create_project') : ('/powner/create_project/'.$data->id) }}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input name="tangal_ditutup" id="tangal_ditutup" class="form-control required" placeholder="yyyy/mm/dd" readonly @if (!empty($data)) value="{{$data->tangal_ditutup}}"@endif>
									</div>
